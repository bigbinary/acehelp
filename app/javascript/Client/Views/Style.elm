...
tickShape width height =
    Svg.svg
        ...
        [ Svg.circle [ Svg.Attributes.fill "#32BA7C", Svg.Attributes.cx "253.6", Svg.Attributes.cy "253.6", Svg.Attributes.r "253.6" ] []
        , Svg.path [ Svg.Attributes.fill "#0AA06E", Svg.Attributes.d "M188.8,368l130.4,130.4c108-28.8,188-127.2,188-244.8c0-2.4,0-4.8,0-7.2L404.8,152L188.8,368z" ] []
        , Svg.g []
            [ Svg.path
